...
const demoCandidates = [
  { id: 'demo-2', name: 'Aarav', destination: 'Manali, India', startDate: '2026-10-16', endDate: '2026-10-20', travellersNeeded: 2, budget: '₹6,000 – ₹10,000 / day', travelStyle: 'Adventure', interests: ['Nature', 'Photography', 'Food'], activities: ['Trekking', 'Sightseeing', 'Camping'], status: 'upcoming', bio: 'Love mountain trips, photography and discovering local food.' },
  { id: 'demo-3', name: 'Meera', destination: 'Manali, India', startDate: '2026-10-14', endDate: '2026-10-19', travellersNeeded: 3, budget: '₹5,000 – ₹8,000 / day', travelStyle: 'Adventure', interests: ['Nature', 'Hiking', 'Photography'], activities: ['Trekking', 'Sightseeing'], status: 'upcoming', bio: 'Looking for easy-going companions for a scenic Himalayan adventure.' },
