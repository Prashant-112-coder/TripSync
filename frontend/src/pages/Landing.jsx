import { ArrowRight, Check, Heart, MapPin, MessageCircle, Sparkles, Users, Zap } from 'lucide-react';
...
export default function Landing() {
  return <div className="landing">
    <header className="landing-nav"><div className="brand"><span className="brand-mark"><Zap size={22} fill="currentColor"/></span><span>Trip<span>Sync</span></span></div><div className="landing-links"><a href="#features">Features</a><a href="#how">How it works</a><a href="#safety">Safety</a></div><div className="landing-actions"><Link to="/dashboard" className="text-btn">Log in</Link><Link to="/dashboard" className="primary-btn">Get started <ArrowRight size={17}/></Link></div></header>
    <section className="hero">
      <div className="hero-copy"><div className="eyebrow"><Sparkles size={15}/> Travel smarter. Together.</div><h1>Find your people.<br/><em>Go farther.</em></h1><p>TripSync connects you with compatible travellers and turns shared interests into unforgettable journeys.</p><div className="hero-actions"><Link to="/dashboard" className="primary-btn large">Find travel companions <ArrowRight size={18}/></Link><a href="#how" className="secondary-btn">See how it works</a></div><div className="hero-proof"><div className="avatar-stack"><img src="https://i.pravatar.cc/60?img=5"/><img src="https://i.pravatar.cc/60?img=32"/><img src="https://i.pravatar.cc/60?img=47"/><span>+2k</span></div><div><strong>2,000+ travellers</strong><small>finding their perfect match</small></div></div></div>
    ...
    <section id="safety" className="cta-section"><div><span>READY FOR YOUR NEXT ADVENTURE?</span><h2>Your next great trip starts with the right people.</h2></div><Link to="/dashboard" className="primary-btn large">Start exploring <ArrowRight size={18}/></Link></section>
